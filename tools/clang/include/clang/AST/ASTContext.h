...
public:
  ...
  typedef llvm::DenseMap<
      const void *,
      llvm::PointerUnion<ast_type_traits::DynTypedNode *, ParentVector *>>
      ParentMap;
...
public:
  ...
  QualType getFunctionType(
      QualType ResultTy, ArrayRef<QualType> Args,
      const FunctionProtoType::ExtProtoInfo &EPI,
      ArrayRef<hlsl::ParameterModifier> ParamMods) const; // HLSL Change
  /// \brief Check whether the function declaration can be used as a patch
  /// constant function.
...
#pragma warning(push)
#pragma warning(                                                               \
    suppress : 6319) // HLSL Change - suppress constant conditional warning
...
public:
  ...
  BuildMicrosoftASTRecordLayout(const RecordDecl *D) const;
